...
<div class="panel panel-forum">
    <div class="panel-heading">
        <h4 class="panel-title text-center" style="color:black">AKUNTANSI</h4>
    </div>
    <div class="row">
        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="slide">
                <div id="ak" class="carousel slide" data-ride="carousel">
                    <!-- Indicators -->
                    <ol class="carousel-indicators">
                    <li data-target="#ak" data-slide-to="0" class="active"></li>
                    <li data-target="#ak" data-slide-to="1"></li>
                    <li data-target="#ak" data-slide-to="2"></li>
                    </ol>
                    ...
                    <a class="left carousel-control" href="#ak" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left"></span>
                    <span class="sr-only">Previous</span>
                    </a>
                    <a class="right carousel-control" href="#ak" data-slide="next">
