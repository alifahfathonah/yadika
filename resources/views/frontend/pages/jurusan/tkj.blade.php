...
<div class="panel panel-forum">
    <div class="panel-heading">
        <h4 class="panel-title text-center" style="color:black">TEKNIK KOMPUTER & JARINGAN</h4>
    </div>
    <div class="row">
        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="slide">
                <div id="tkj" class="carousel slide" data-ride="carousel">
                    ...
                    <a class="left carousel-control" href="#tkj" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left"></span>
                    <span class="sr-only">Previous</span>
                    </a>
                    <a class="right carousel-control" href="#tkj" data-slide="next">
        ...
        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="card">
                <div class="body-card">
                    <h4 class="text-center" style="color:slateblue; font-weight:bold">SEKILAS TENTANG TEKNIK KOMPUTER & JARINGAN</h4>
