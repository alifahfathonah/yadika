...
@section('title','Pages Teknik Otomotif')
@section('content')
@if ($cek == !null)
<div class="col-12 mt-3">
    <div class="card">
        <div class="card-body">
            <h4 class="header-title mt-0 mb-1">Pages Teknik Otomotif
